...
pub const Disassembler = struct {
    ...
    pub fn disassemble(self: *Disassembler) !void {
        ...
        switch (byte) {
            ...
            @enumToInt(opcode.Opcode.RST_00) => try self.output.print("rst 0x00"),
            @enumToInt(opcode.Opcode.RST_08) => try self.output.print("rst 0x08"),
            @enumToInt(opcode.Opcode.RST_10) => try self.output.print("rst 0x10"),
            @enumToInt(opcode.Opcode.RST_18) => try self.output.print("rst 0x18"),
            @enumToInt(opcode.Opcode.RST_20) => try self.output.print("rst 0x20"),
            @enumToInt(opcode.Opcode.RST_28) => try self.output.print("rst 0x28"),
            @enumToInt(opcode.Opcode.RST_30) => try self.output.print("rst 0x30"),
            @enumToInt(opcode.Opcode.RST_38) => try self.output.print("rst 0x38"),
